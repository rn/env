...

;;;### (autoloads nil "dtrt-indent" "dtrt-indent.el" (24929 36768
;;;;;;  872509 875000))
...
`(lambda nil (when (derived-mode-p (quote prog-mode) (quote text-mode) (quote javascript-mode)) (dtrt-indent-mode)))' would do it.
